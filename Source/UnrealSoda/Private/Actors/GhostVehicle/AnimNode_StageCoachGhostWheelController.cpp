...
FAnimNode_StageCoachGhostWheelController::FAnimNode_StageCoachGhostWheelController()
	: WheelSpokeCount(5)
...
void FAnimNode_StageCoachGhostWheelController::GatherDebugData(FNodeDebugData& DebugData)
{
...
void FAnimNode_StageCoachGhostWheelController::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
...
bool FAnimNode_StageCoachGhostWheelController::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones) 
{
...
void FAnimNode_StageCoachGhostWheelController::InitializeBoneReferences(const FBoneContainer& RequiredBones) 
{
	const TArray<FGhostWheelAnimationData>& WheelAnimData = AnimInstanceProxy->GetWheelAnimData();
...
void FAnimNode_StageCoachGhostWheelController::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
	AnimInstanceProxy = (FGhostVehicleAnimationInstanceProxy*)Context.AnimInstanceProxy;
