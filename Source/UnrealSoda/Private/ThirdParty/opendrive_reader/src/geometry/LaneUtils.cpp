...
static bool points_near(const opendrive::Point & left, const opendrive::Point & right, double resolution = 1e-3)
{
...
void checkAddPredecessor(Lane &lane, Lane const &otherLane)
{
  ...
  if ((points_near(thisLeftStart, otherLeftEnd) && points_near(thisRightStart, otherRightEnd))
      || (points_near(thisLeftStart, otherRightStart) && points_near(thisRightStart, otherLeftStart)))
  {
...
void checkAddSuccessor(Lane &lane, Lane const &otherLane)
{
  ...
  if ((points_near(thisLeftEnd, otherLeftStart) && points_near(thisRightEnd, otherRightStart))
      || (points_near(thisLeftEnd, otherRightEnd) && points_near(thisRightEnd, otherLeftEnd)))
  {
