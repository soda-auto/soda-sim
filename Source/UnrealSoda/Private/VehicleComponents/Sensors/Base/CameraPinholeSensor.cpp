...
/* **********************************************************************************************
 * UCameraPinholeSensor
 * **********************************************************************************************/

UCameraPinholeSensor::UCameraPinholeSensor(const FObjectInitializer& ObjectInitializer)
...
bool UCameraPinholeSensor::OnActivateVehicleComponent()
{
...
void UCameraPinholeSensor::OnDeactivateVehicleComponent()
{
	Super::OnDeactivateVehicleComponent();
	Clean();
}

void UCameraPinholeSensor::Clean()
{
...
void UCameraPinholeSensor::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
bool UCameraPinholeSensor::GenerateFOVMesh(TArray<FSensorFOVMesh>& Meshes)
{
