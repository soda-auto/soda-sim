...
void UAutoWiringComponent::OnResponseReceived(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bConnectedSuccessfully)
{
   if (bConnectedSuccessfully && Response.IsValid())
   {
      ...
      FString JsonString =
         ...
         TEXT("\"labelText\": \"ECU2.Pin1 <-> Left Low Beam\\nECU2.Pin2 <-> Left DRL\"")
         TEXT("},")
         TEXT("{")
         ...
         TEXT("\"title\": \"FR ECU\",")
         TEXT("\"coordinates\": [2.7, 0.47, 0.14],")
         TEXT("\"labelText\": \"ECU1.Pin1 <-> Right Low Beam\\nECU1.Pin2 <-> Right DRL\\nECU1.Pin3 <->DU.Pin4\"")
         TEXT("},")
         TEXT("{")
         ...
         TEXT("\"labelText\":  \"ECU3.Pin1 <-> RL Brake Light\\nECU3.Pin2 <-> RL Turn Indicator\\nECU3.Pin3 <-> RR Brake Light\\nECU3.Pin4 <-> RR Turn Indicator\"")
         TEXT("}")
         TEXT("],")
         TEXT("\"connections\": [")
         TEXT("{")
