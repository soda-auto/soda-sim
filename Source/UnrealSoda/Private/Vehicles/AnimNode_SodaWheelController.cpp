...
#include "Soda/Vehicles/AnimNode_SodaWheelController.h"
...
FAnimNode_SodaWheelController::FAnimNode_SodaWheelController()
{
	AnimInstanceProxy = nullptr;
}

void FAnimNode_SodaWheelController::GatherDebugData(FNodeDebugData& DebugData)
{
...
void FAnimNode_SodaWheelController::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output, TArray<FBoneTransform>& OutBoneTransforms)
{
...
bool FAnimNode_SodaWheelController::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones) 
{
...
void FAnimNode_SodaWheelController::InitializeBoneReferences(const FBoneContainer& RequiredBones) 
{
	const TArray<FSodaWheelAnimationData>& WheelAnimData = AnimInstanceProxy->GetWheelAnimData();
...
void FAnimNode_SodaWheelController::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
	AnimInstanceProxy = (FSodaVehicleAnimationInstanceProxy*)Context.AnimInstanceProxy;	//TODO: This is cached for now because we need it in eval bone transforms.
}
