...
class FehicleDifferentialSimpleComponent_Handler : public FObjectDatasetMongDBHandler
{
public:
	FehicleDifferentialSimpleComponent_Handler(UVehicleDifferentialSimpleComponent* Outer)
	...
	TWeakObjectPtr<UVehicleDifferentialSimpleComponent> Outer;
};
