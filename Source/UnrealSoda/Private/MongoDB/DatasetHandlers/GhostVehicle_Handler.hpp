...
class FGhostVehicle_Handler: public FObjectDatasetMongDBHandler
{
public:

	FGhostVehicle_Handler(AGhostVehicle* Outer)
	...
	virtual bool Sync(bsoncxx::builder::stream::document& Doc) override
	{
		...
		FVector Acc = FVector(Outer->GetCurrentAcc(), 0, 0);
	...
	TWeakObjectPtr<AGhostVehicle> Outer;
};
