...
class FVehicleInputKeyboardComponent_Handler : public FObjectDatasetMongDBHandler
{
public:
	FVehicleInputKeyboardComponent_Handler(UVehicleInputKeyboardComponent* Outer)
	...
	virtual bool Sync(bsoncxx::builder::stream::document& Doc) override
	{
		...
		Doc
			...
			<< "SteerTension" << Outer->GetFeedbackDriverSteerTension();
		return true;
	}

	TWeakObjectPtr<UVehicleInputKeyboardComponent> Outer;
};
