...
public:
	FVector PosnLocalSpace;
	FVector TangetLocalSpace;
	ESplinePointType::Type PointTyp;
};
...
public:
	...
	bool SetRoutePointsAdv(const TArray<FSplinePointInfo>& RoutePoints, bool bUpdateMesh = true);
