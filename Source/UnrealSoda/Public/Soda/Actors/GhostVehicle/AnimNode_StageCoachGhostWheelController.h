...
#include "AnimNode_StageCoachWheelController.generated.h"

/**
 *	Simple controller that replaces or adds to the translation/rotation of a single bone.
 */
USTRUCT()
struct UNREALSODA_API FAnimNode_StageCoachGhostWheelController : public FAnimNode_SkeletalControlBase
{
	...
	FAnimNode_StageCoachGhostWheelController();
