...
class UNREALSODA_API UImuSensorComponent : public USensorComponent
{
	GENERATED_UCLASS_BODY()

public:
	/** Whether to save debugging information of this sensor to a file */
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Debug, SaveGame, meta = (EditInRuntime, ReactivateComponent))
	FString CSVPath = "/tmp/imu_path.csv";
