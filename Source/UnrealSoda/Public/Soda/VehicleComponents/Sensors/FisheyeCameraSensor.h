...
#include <future>
#include "FisheyeCameraSensor.generated.h"
...
class UNREALSODA_API UFisheyeCameraSensorComponent : public UCameraBaseSensorComponent
{
	GENERATED_UCLASS_BODY()
