...
public:
	 ...
	 */ 
	static FSlateFontInfo GetRegularFont() { return FSodaStyle::GetFontStyle( TEXT("PropertyWindow.NormalFont") ); }

	/**
	 * @return the bold font used for properties and details
	 */ 
	static FSlateFontInfo GetBoldFont() { return FSodaStyle::GetFontStyle( TEXT("PropertyWindow.BoldFont") ); }
