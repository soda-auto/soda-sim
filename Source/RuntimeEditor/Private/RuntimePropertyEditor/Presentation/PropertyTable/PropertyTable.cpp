...
#include "RuntimePropertyEditor/Presentation/PropertyTable/PropertyTableRow.h"
#include "RuntimePropertyEditor/Presentation/PropertyTable/PropertyTableRowHeaderColumn.h"
...
FNotifyHook* FPropertyTable::GetNotifyHook() const
{
	return NULL;
...
const TArray<TSharedRef<IClassViewerFilter>>& FPropertyTable::GetClassViewerFilters() const
{
	// not implemented
...
void FPropertyTable::PasteTextAtCell( const FString& Text, const TSharedRef< IPropertyTableCell >& Cell )
{
	...
	int32 NumPasteOperationsBeforeWarning = 20;//GetDefault<UEditorPerProjectUserSettings>()->PropertyMatrix_NumberOfPasteOperationsBeforeWarning;
