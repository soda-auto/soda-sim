...
#include "AnimGraphNode_StageCoachGhostWheelController.generated.h"

class UEdGraph;

UCLASS(MinimalAPI, meta=(Keywords = "Modify Wheel Vehicle"))
class UAnimGraphNode_StageCoachGhostWheelController : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_StageCoachGhostWheelController Node;
