...
set_target_properties(SodaSimProtoV1::generic-msgs PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/soda-sim-proto-v1.lib"
  )

list(APPEND _cmake_import_check_targets SodaSimProtoV1::generic-msgs )
list(APPEND _cmake_import_check_files_for_SodaSimProtoV1::generic-msgs "${_IMPORT_PREFIX}/lib/soda-sim-proto-v1.lib" )
